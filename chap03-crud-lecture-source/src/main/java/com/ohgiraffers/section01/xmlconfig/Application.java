...
=======
    public static void main(String[] args) {
        /* 필기.
        *   우리는 아직 view 즉 사용자들이 정보를 입력할 수 있는 화면을 배우지 않았다.
        *   따라서 아직은 Application이 view라고 생각하고 진행을 해보자.
>>>>>>> 921de99 ([SqlSession])
        *  */
...
=======
            ...
            switch (no){
                ...
                case 2: menuController.selectMenuByCode(inputMenuCode()); break;
                case 3: menuController.registMenu(inputMenu());break;
                case 4: menuController.updateMenu(plusMenu()); break;
                case 5: menuController.deleteMenu(inputMenuCode()); break;
                default:
                    System.out.println("잘못된 메뉴를 입력하셨습니다."); break;
            }
...
=======
    ...
    private static Map<String,String> plusMenu(){
        Scanner sc = new Scanner(System.in);
        ...
        System.out.print("판매 유무 입력 Y/N : ");
        String orderableStatus = sc.nextLine();

        Map<String,String>parameter = new HashMap<>();      //다형성, 파라미터라는 맵에 key, value로 저장
        parameter.put("code", code);
        parameter.put("name", name);
        parameter.put("price", price);
        parameter.put("categoryCode", categoryCode);
